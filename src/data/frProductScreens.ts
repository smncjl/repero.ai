...
export const frProductScreens: ProductScreen[] = [
  {
    ...
    alt: "Capture d ecran de Repero AI montrant un artefact ouvert a cote de la liste des artefacts dans la conversation.",
  ...
  },
  {
    ...
    alt: "Capture d ecran de Repero AI montrant le panneau de contexte actif avec les sections sources et artefacts.",
  ...
  },
  {
    ...
    alt: "Capture d ecran de Repero AI montrant la recherche de contexte avec les sections contexte actif et sources visibles.",
  ...
  },
  {
    ...
    alt: "Capture d ecran de Repero AI montrant les sources web et les documents dans le meme panneau sources.",
  ...
  },
  {
    ...
    description:
      'Les projets et les conversations recentes restent visibles dans la meme navigation.',
    image: '/product/fr/projects-conversations.png',
    alt: "Capture d ecran de Repero AI montrant les projets et la liste des conversations recentes dans la navigation laterale.",
